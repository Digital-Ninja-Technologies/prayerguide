      ...
      body: Column(
        children: [
          Padding(
            ...
            child: PgHeader(title: 'Prayer Guide', onBack: () => context.pop()),
          ),
          Expanded(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text("Choose how you'll pray today.",
                    ...
                    child: Row(
                      children: [
                        PgPill(
                            label: '☀ Morning',
                            active: _morning,
                            onTap: () => setState(() => _morning = true)),
                        const SizedBox(width: 8),
                        PgPill(
                            label: '☾ Evening',
                            active: !_morning,
                            onTap: () => setState(() => _morning = false)),
                      ],
                    ),
                  ),
                  for (final g in guideCategories)
                    Padding(
                      ...
                      child: PgCard(
                        ...
                        onTap: () => context.push(
                            '/guide?category=${Uri.encodeComponent(g.name)}'),
                        child: Row(
                          children: [
                            PgIconBadge(
