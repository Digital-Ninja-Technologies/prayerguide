      ...
      body: Column(
        children: [
          Padding(
            ...
            child: PgHeader(title: 'Growth', onBack: () => context.pop()),
          ),
          Expanded(
      ...
      children: [
        Row(
          children: [
            Expanded(
                child: _StatCard(
                    value: insights.totalTimeLabel, label: 'Prayed this week')),
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                height: (insights.dailyMinutes[i] / maxMin * 84)
                                    .clamp(4, 84)
                                    .toDouble(),
                                decoration: BoxDecoration(
                                  color: insights.dailyMinutes[i] > 0
                                      ? c.teal
                                      : c.line2,
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('A gentle insight',
                        style: TextStyle(
                            fontSize: 14, fontWeight: FontWeight.w700)),
                    const SizedBox(height: 5),
                    Text(insights.gentleInsight,
                        style: TextStyle(
                            fontSize: 13.5, height: 1.6, color: c.dim)),
                  ],
                ),
              ),
            ],
