...
/// The image that gets saved/shared for a Scripture of the Day — a fixed,
/// self-contained visual (not the on-screen `ScriptureScreen`, which has
...
/// same regardless of the sharer's or viewer's device theme.
class ScriptureShareCard extends StatelessWidget {
  const ScriptureShareCard({
    super.key,
    required this.quote,
      ...
      child: Column(
        children: [
          Padding(
            ...
            child: Row(
              children: [
                Image.asset('assets/icon/flame_logo.png', width: 20, height: 20),
              ...
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    style: PgText.serif(
                        size: 19, weight: FontWeight.w500, height: 1.45, color: _text),
                  ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: ScriptureShareCard._teal.withValues(alpha: 0.14),
        borderRadius: BorderRadius.circular(20),
        border: Border.all(color: ScriptureShareCard._teal.withValues(alpha: 0.4)),
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(icon, size: 13, color: ScriptureShareCard._teal),
          const SizedBox(width: 5),
          Text(label,
              style: const TextStyle(
                  fontSize: 10.5,
                  fontWeight: FontWeight.w700,
                  color: ScriptureShareCard._teal)),
        ],
      ),
    );
  }
