                ...
                children: [
                  challengesAsync.when(
                    ...
                    error: (e, st) => PgErrorState(
                        error: e,
                        onRetry: () => ref.invalidate(challengeProvider)),
                    data: (all) {
                      final inProgress =
                          ref.read(challengeProvider.notifier).mostRecentActive;
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          if (inProgress != null)
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                    ...
                                    children: [
                                      Text('IN PROGRESS',
                                          style: PgText.sans(
                                              ...
                                              letterSpacing: 1)),
                                      Text(
                                          'Day ${inProgress.currentDay} / ${inProgress.totalDays}',
                                          style: TextStyle(
                                              fontSize: 13,
                                              fontWeight: FontWeight.w800,
                                              color: c.teal)),
                                  ...
                                  PgButton(
                                    label:
                                        'Continue — Day ${inProgress.currentDay + 1}',
                                    onPressed: () => context.push(
                                        '/challenges/${inProgress.challengeKey}'),
                                  ),
                                ],
                              ),
                            ),
                          ...
                          for (final ch in challengeCatalog.values)
                            Padding(
                              ...
                              child: PgCard(
                                ...
                                onTap: () =>
                                    context.push('/challenges/${ch.key}'),
                                child: Row(
                                  children: [
                                    PgIconBadge(
