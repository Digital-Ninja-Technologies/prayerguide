        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(def.name, style: PgText.serif(size: 27, weight: FontWeight.w600)),
            ),
            libraryAsync.when(
              ...
              data: (library) {
                ...
                final pct = def.totalDays == 0 ? 0.0 : daysCompleted / def.totalDays;
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            finished ? "YOU'VE FINISHED THIS PLAN" : "DAY $nextDay'S READING",
                            style: PgText.sans(size: 11, weight: FontWeight.w800, color: c.teal, letterSpacing: 1),
                          ),
                          const SizedBox(height: 8),
                          Text(
                            finished ? 'Every chapter, read. Consider starting again, or pick a new plan.' : readingLabel,
                    ...
                    if (!finished) ...[
                      PgButton(
                        label: daysCompleted == 0 ? 'Read Day 1' : 'Read Day $nextDay',
                        icon: const Icon(Icons.menu_book_outlined, size: 18),
                        onPressed: firstReading == null
                            ? null
                            : () => context.go('/bible?book=${Uri.encodeComponent(firstReading.$1)}&chapter=${firstReading.$2}'),
                      ),
                      const SizedBox(height: 11),
                      PgButton(
                        label: 'Mark Day $nextDay as read',
                        variant: PgButtonVariant.outline,
                        onPressed: () => ref.read(readingPlanProvider.notifier).markDayComplete(
                              planKey: planKey,
                      ...
                      PgButton(
                        ...
                        onPressed: firstReading == null
                            ...
                            : () {
                                ...
                                context.go('/bible?book=${Uri.encodeComponent(first.$1)}&chapter=${first.$2}');
                              },
                      ),
                  ],
                );
