      ...
      body: Column(
        children: [
          Padding(
            ...
            child: PgHeader(eyebrow: def.sub, onBack: () => context.pop()),
          ),
          Expanded(
                ...
                children: [
                  ...
                  libraryAsync.when(
                    ...
                    data: (library) {
                      ...
                      final nextDay =
                          finished ? def.totalDays : daysCompleted + 1;
                      final readingLabel = schedule.label(nextDay);
                      final firstReading = schedule.firstOf(nextDay);
                      final pct = def.totalDays == 0
                          ? 0.0
                          : daysCompleted / def.totalDays;
                                  ...
                                  children: [
                                    Text('Progress',
                                        style: TextStyle(
                                            ...
                                            color: c.dim)),
                                    Text(
                                        'Day $daysCompleted of ${def.totalDays}',
                                        style: TextStyle(
                                            fontSize: 13,
                          ...
                          if (!finished) ...[
                            PgButton(
                              ...
                              onPressed: firstReading == null
                                  ? null
                                  : () => context.go(
                                      '/bible?book=${Uri.encodeComponent(firstReading.$1)}&chapter=${firstReading.$2}&planKey=${Uri.encodeComponent(planKey)}&day=$nextDay'),
                            ),
